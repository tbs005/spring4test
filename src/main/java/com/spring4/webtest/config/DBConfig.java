 ...
 */
@Configuration
//@ComponentScan(basePackages = {"com.spring4.webtest.dao","com.spring4.webtest.domain"})
@EnableJpaRepositories(basePackages = {"com.spring4.webtest.dao","com.spring4.webtest.domain"})
